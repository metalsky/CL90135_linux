...
#else
    static struct resource cl90135_mmc_resources[] = {
	        [0] = {		 /* registers */
		        .start	= (0x60000000),
		        .end	= (0x60000000) + SZ_4K - 1,
		        .flags	= IORESOURCE_MEM
	        },
//
...
//
        ...
        static struct platform_device cl90135_mmc_device = {
        // impostare il nome con lo stesso nome usato nel driver altrimenti non funziona niente!!!!
        // cioè non viene chiamato il probe
	        .name		= "CL90135_sd",
	        .id		= 0,
	        .num_resources	= ARRAY_SIZE(cl90135_mmc_resources),
	        .resource	= cl90135_mmc_resources,
        };
#endif
...
#else
	[DA8XX_PDEV_MMC]	= &cl90135_mmc_device,
#endif	
