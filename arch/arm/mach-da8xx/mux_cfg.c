...
static const short da8xx_emif25_pins[] = {
	...
	DA8XX_EMA_SDCKE, DA8XX_NEMA_CS_4, DA8XX_NEMA_WE,  //DA8XX_NEMA_CS_5 used as fpga interrupt pins
...
// Michele: definizione pin di i/o...
// GPIO2[13]=reset fpga activelow
// GPIO4[4] =red led
// GPIO4[5] =green led #1
// GPIO4[6] =green led #2
// GPIO4[7] =green led #3
static const short da8xx_gpio_pins[]={
	DA8XX_GPIO2_13,
	DA8XX_GPIO4_4,
	DA8XX_GPIO4_5,
	DA8XX_GPIO4_6,
...
// Michele: CL90135 deve usare EMIFA, non SD	
...
// Michele: provo  ad introdurre una configurazione per le i/o	
	[DA8XX_LPSC1_GPIO]  = da8xx_gpio_pins,
	
// Michele: la uhpi è in conflitto con emifa...
//	[DA8XX_LPSC1_UHPI]	= da8xx_uhpi_pins,
	[DA8XX_LPSC1_CPGMAC]	= da8xx_cpgmac_pins,
	[DA8XX_LPSC1_EMIF3C]	= da8xx_emif3c_pins,
// Michele: non uso mcasp!	
...
// Michele: anche lcd è in conflitto con EMIFA	
