 ...
 */
	...
	printk(KERN_NOTICE "start kernel: profile init\n");
	...
	printk(KERN_NOTICE "start kernel: mem init\n");
	...
	printk(KERN_NOTICE "start kernel: fork init\n");
	...
	printk(KERN_NOTICE "start kernel: page writeback init\n");
	...
	printk(KERN_NOTICE "start kernel: acpi init\n");
	...
	printk(KERN_NOTICE "*** *** start kernel: end of rest init\n");
}
